// Simple Groq API test with hardcoded key for testing
const https = require('https');

// Hardcode the API key for testing (from .env file)
const GROQ_API_KEY = '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';
