...
const Store = () => {
  ...
  return (
    <>
      <Helmet>
        <title>XP Store | Study Nova - Gamified Learning Platform</title>
        <meta name="description" content="Shop for themes, titles, and rewards with your earned XP in the Study Nova store. Complete learning tasks to earn more XP!" />
      </Helmet>
          ...
          <Card className="overflow-hidden">
            <CardHeader className="bg-card py-6">
              <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                <div>
                  <CardTitle className="text-2xl font-bold">Study Nova Store</CardTitle>
