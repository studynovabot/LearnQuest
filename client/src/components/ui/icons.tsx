...
export const FlashlightIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg
    ...
    {...props}
  >
    <path d="M18 6c0 2-2 4-2 4H8s-2-2-2-4a4 4 0 0 1 8 0Z" />
    <path d="M16 14h-2a4 4 0 0 0-4 4v1a3 3 0 0 0 3 3h4a3 3 0 0 0 3-3v-1a4 4 0 0 0-4-4Z" />
    <path d="M7.5 13.5 11 17" />
  </svg>
);
...
export const SpaceshipIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg
    ...
    {...props}
  >
    <path d="M10 9a6 6 0 0 0 11.5 3.5" />
    <path d="m9.44 12.5-.95-1a1 1 0 0 0-1.49 1.3l.55.62a3.02 3.02 0 0 1 .35 3.82c-.15.23-.37.4-.59.5" />
    <path d="M14.5 8.5c-.53-2.5-2.36-4.39-2.72-4.75a2.14 2.14 0 0 0-3.06 0c-.36.36-2.19 2.25-2.72 4.75" />
    <path d="M12 16a4 4 0 0 0 4-4c0-3-2-3-2-8 0 5-2 5-2 8a4 4 0 0 0 0 4Z" />
  </svg>
);
...
export const BagIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg
    ...
    {...props}
  >
    <path d="M6 2h12a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4c0-1.1.9-2 2-2Z" />
    <path d="M6 22V7" />
    <path d="M18 22V7" />
    <path d="M6 7h12" />
    <path d="M6 12h12" />
...
export const InfinityIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg
    ...
    {...props}
  >
    <path d="M12 12c-2-2.67-4-4-6-4a4 4 0 1 0 0 8c2 0 4-1.33 6-4s4-4 6-4a4 4 0 1 1 0 8c-2 0-4-1.33-6-4z" />
  </svg>
);
...
export const FlaskIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg
    ...
    {...props}
  >
    <path d="M9 2v6l-4 7a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1l-4-7V2" />
    <path d="M6.5 15.5h11" />
    <path d="M9 2h6" />
  </svg>
);
...
export const TestTubeIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  ...
  >
    ...
    <path d="M8.5 2h7" />
    <path d="M16.5 6.5 20 10c1.4 1.4 1.4 3.6 0 5L16.5 18.5" />
  </svg>
);
